...
name: caveman
description: >
  Use ONLY when user says "caveman mode", "talk like caveman", "use caveman", 
  "less tokens", "be brief", or invokes /caveman. Ultra-compressed communication 
  that cuts token usage ~75% while keeping full technical accuracy. Supports 
